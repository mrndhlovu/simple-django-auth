...
from .views import (api_overview, registration_api_view, verify_account_api_view,
                    delete_user_api_view, update_api_view, log_api_view, UpdatePasswordAPIView, user_api_view)
...
urlpatterns = [
    ...
    path('update/', update_api_view, name='update'),
